...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/Heiheiaoo/HeiGate/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/Heiheiaoo/HeiGate/blob/main/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 HeiGate 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the HeiGate Deployment and Operation Compliance Commitment"
