...
type PluginRequirements struct {
	HeiGate                   string   `json:"sub2api"`
	RecommendedHeiGateVersion string   `json:"recommended_sub2api_version,omitempty"`
	TestedHeiGateVersions     []string `json:"tested_sub2api_versions,omitempty"`
...
type PluginCompatibility struct {
	...
	CurrentHeiGate     string `json:"current_sub2api_version"`
	RequiredHeiGate    string `json:"required_sub2api_version"`
	RecommendedHeiGate string `json:"recommended_sub2api_version"`
	PluginProtocol     int    `json:"plugin_protocol"`
	TransportAPI       int    `json:"transport_api"`
	UIBridge           int    `json:"ui_bridge"`
}
...
func (m PluginManifest) Validate() error {
	...
	if strings.TrimSpace(m.Requires.HeiGate) == "" {
