# HeiGate Docker Image

HeiGate is an AI API Gateway Platform for distributing and managing AI product subscription API quotas.
...
docker run -d \
  ...
  ghcr.io/heiheiaoo/heigate:latest
```
...
services:
  sub2api:
    image: ghcr.io/heiheiaoo/heigate:latest
    ports:
      - "8080:8080"
    environment:
...
HeiGate runs database migrations while starting. PostgreSQL may still be
...
- [GitHub Repository](https://github.com/Heiheiaoo/HeiGate)
- [Documentation](https://github.com/Heiheiaoo/HeiGate#readme)
